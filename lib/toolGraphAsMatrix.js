...
var toolbarGraphAsMatrixDefinition={
   ...
   //       var rows2= nodes.diff(nodes.leaves()) ; var columns2= nodes.diff(nodes.roots())
          ...
          maxWidth = calculateMaxLengthFromLabel(cy.nodes());
...
function calculateMaxLengthFromLabel (nodes){
  ...
  function save_matrix_as_svg(){
    ...
    let svg_data = document.getElementById("mySVGMatrix").innerHTML //put id of your svg element here

    let head = '<svg title="ArchiMateCG Matrix" version="1.1" xmlns="http://www.w3.org/2000/svg">'
